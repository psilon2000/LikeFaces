                    ...
                    Inputs = new Dictionary<string, StringTable>() {
                        {
                            ...
                            new StringTable()
                            {
                                ColumnNames = new string[] {"Id", "FaceWidth", "FaceHeight", "FacePositionLeft", "FacePositionTop", "PupilLeftX", "PupilLeftY", "PupilRightX", "PupilRightY", "NoseTipX", "NoseTipY", "MouthLeftX", "MouthLeftY", "MouthRightX", "MouthRightY", "EyebrowLeftOuterX", "EyebrowLeftOuterY", "EyebrowLeftInnerX", "EyebrowLeftInnerY", "EyeLeftOuterX", "EyeLeftOuterY", "EyeLeftTopX", "EyeLeftTopY", "EyeLeftBottomX", "EyeLeftBottomY", "EyeLeftInnerX", "EyeLeftInnerY", "EyebrowRightOuterX", "EyebrowRightOuterY", "EyebrowRightInnerX", "EyebrowRightInnerY", "EyeRightOuterX", "EyeRightOuterY", "EyeRightTopX", "EyeRightTopY", "EyeRightBottomX", "EyeRightBottomY", "EyeRightInnerX", "EyeRightInnerY", "NoseRootLeftX", "NoseRootLeftY", "NoseRootRightX", "NoseRootRightY", "NoseLeftAlarTopX", "NoseLeftAlarTopY", "NoseRightAlarTopX", "NoseRightAlarTopY", "NoseLeftAlarOutTipX", "NoseLeftAlarOutTipY", "NoseRightAlarOutTipX", "NoseRightAlarOutTipY", "UpperLipTopX", "UpperLipTopY", "UpperLipBottomX", "UpperLipBottomY", "UnderLipTopX", "UnderLipTopY", "UnderLipBottomX", "UnderLipBottomY", "Age", "Gender", "Smile", "FacialHairMustache", "FacialHairBeard", "FacialHairSideburns", "Glasses", "HeadPoseRoll", "HeadPoseYaw", "HeadPosePitch", "ScoreNeutral", "ScoreFear", "ScoreHappiness", "ScoreSandess", "ScoreAnger", "ScoreContempt", "ScoreDisgust", "ScoreSurprise", "Like"},
